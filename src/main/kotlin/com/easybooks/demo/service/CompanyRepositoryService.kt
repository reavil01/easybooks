...
import com.easybooks.demo.web.dto.company.*
...
class CompanyRepositoryService(
    ...
    fun findByNumber(companyNumber: String): CompanyResponseDto {
        val company = companyRepository.findByNumber(companyNumber)
